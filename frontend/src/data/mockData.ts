...
const timeslots: Timeslot[] = [
    { id: 'ts1', dayOfWeek: 'MONDAY', startTime: '08:00', endTime: '10:00', preferenceBonus: 1.0 },
    { id: 'ts2', dayOfWeek: 'MONDAY', startTime: '10:00', endTime: '12:00', preferenceBonus: 0.95 },
    { id: 'ts3', dayOfWeek: 'MONDAY', startTime: '13:00', endTime: '15:00', preferenceBonus: 0.9 },
    { id: 'ts4', dayOfWeek: 'MONDAY', startTime: '15:00', endTime: '17:00', preferenceBonus: 0.8 },
    { id: 'ts5', dayOfWeek: 'MONDAY', startTime: '08:00', endTime: '11:00', preferenceBonus: 1.0 },
    { id: 'ts6', dayOfWeek: 'MONDAY', startTime: '13:00', endTime: '16:00', preferenceBonus: 0.85 },
    { id: 'ts7', dayOfWeek: 'TUESDAY', startTime: '08:00', endTime: '10:00', preferenceBonus: 1.0 },
    { id: 'ts8', dayOfWeek: 'TUESDAY', startTime: '10:00', endTime: '12:00', preferenceBonus: 0.95 },
    { id: 'ts9', dayOfWeek: 'TUESDAY', startTime: '13:00', endTime: '15:00', preferenceBonus: 0.9 },
    { id: 'ts10', dayOfWeek: 'TUESDAY', startTime: '15:00', endTime: '17:00', preferenceBonus: 0.8 },
    { id: 'ts11', dayOfWeek: 'TUESDAY', startTime: '08:00', endTime: '11:00', preferenceBonus: 1.0 },
    { id: 'ts12', dayOfWeek: 'TUESDAY', startTime: '13:00', endTime: '16:00', preferenceBonus: 0.85 },
    { id: 'ts13', dayOfWeek: 'WEDNESDAY', startTime: '08:00', endTime: '10:00', preferenceBonus: 1.0 },
    { id: 'ts14', dayOfWeek: 'WEDNESDAY', startTime: '10:00', endTime: '12:00', preferenceBonus: 0.95 },
    { id: 'ts15', dayOfWeek: 'WEDNESDAY', startTime: '13:00', endTime: '15:00', preferenceBonus: 0.9 },
    { id: 'ts16', dayOfWeek: 'WEDNESDAY', startTime: '15:00', endTime: '17:00', preferenceBonus: 0.8 },
    { id: 'ts17', dayOfWeek: 'WEDNESDAY', startTime: '08:00', endTime: '11:00', preferenceBonus: 1.0 },
    { id: 'ts18', dayOfWeek: 'WEDNESDAY', startTime: '13:00', endTime: '16:00', preferenceBonus: 0.85 },
    { id: 'ts19', dayOfWeek: 'THURSDAY', startTime: '08:00', endTime: '10:00', preferenceBonus: 1.0 },
    { id: 'ts20', dayOfWeek: 'THURSDAY', startTime: '10:00', endTime: '12:00', preferenceBonus: 0.95 },
    { id: 'ts21', dayOfWeek: 'THURSDAY', startTime: '13:00', endTime: '15:00', preferenceBonus: 0.9 },
    { id: 'ts22', dayOfWeek: 'THURSDAY', startTime: '15:00', endTime: '17:00', preferenceBonus: 0.8 },
    { id: 'ts23', dayOfWeek: 'THURSDAY', startTime: '08:00', endTime: '11:00', preferenceBonus: 1.0 },
    { id: 'ts24', dayOfWeek: 'THURSDAY', startTime: '13:00', endTime: '16:00', preferenceBonus: 0.85 },
    { id: 'ts25', dayOfWeek: 'FRIDAY', startTime: '08:00', endTime: '10:00', preferenceBonus: 0.95 },
    { id: 'ts26', dayOfWeek: 'FRIDAY', startTime: '10:00', endTime: '12:00', preferenceBonus: 0.9 },
    { id: 'ts27', dayOfWeek: 'FRIDAY', startTime: '13:00', endTime: '15:00', preferenceBonus: 0.85 },
    { id: 'ts28', dayOfWeek: 'FRIDAY', startTime: '15:00', endTime: '17:00', preferenceBonus: 0.75 },
    { id: 'ts29', dayOfWeek: 'FRIDAY', startTime: '08:00', endTime: '11:00', preferenceBonus: 0.95 },
    { id: 'ts30', dayOfWeek: 'FRIDAY', startTime: '13:00', endTime: '16:00', preferenceBonus: 0.8 },
];
...
let lessons: Lesson[] = [
    { id: 'l1', subject: 'Introduction to Programming', teacher: 'Dr. Smith', studentGroup: 'CS-1', difficultyWeight: 0.7, satisfactionScore: 0.85, pinned: false, durationHours: 2 },
    { id: 'l2', subject: 'Data Structures', teacher: 'Dr. Johnson', studentGroup: 'CS-2', difficultyWeight: 0.85, satisfactionScore: 0.8, pinned: false, durationHours: 3 },
    { id: 'l3', subject: 'Algorithms', teacher: 'Dr. Johnson', studentGroup: 'CS-2', difficultyWeight: 0.9, satisfactionScore: 0.75, pinned: false, durationHours: 3 },
    { id: 'l4', subject: 'Database Systems', teacher: 'Prof. Williams', studentGroup: 'CS-3', difficultyWeight: 0.75, satisfactionScore: 0.88, pinned: false, durationHours: 2 },
    { id: 'l5', subject: 'Operating Systems', teacher: 'Dr. Brown', studentGroup: 'CS-3', difficultyWeight: 0.82, satisfactionScore: 0.7, pinned: false, durationHours: 2 },
    { id: 'l6', subject: 'Computer Networks', teacher: 'Dr. Davis', studentGroup: 'CS-3', difficultyWeight: 0.78, satisfactionScore: 0.82, pinned: false, durationHours: 2 },
    { id: 'l7', subject: 'Linear Algebra', teacher: 'Prof. Miller', studentGroup: 'MATH-1', difficultyWeight: 0.88, satisfactionScore: 0.65, pinned: false, durationHours: 2 },
    { id: 'l8', subject: 'Calculus II', teacher: 'Prof. Miller', studentGroup: 'MATH-1', difficultyWeight: 0.92, satisfactionScore: 0.6, pinned: false, durationHours: 3 },
    { id: 'l9', subject: 'Statistics', teacher: 'Dr. Wilson', studentGroup: 'MATH-2', difficultyWeight: 0.72, satisfactionScore: 0.78, pinned: false, durationHours: 2 },
    { id: 'l10', subject: 'Machine Learning', teacher: 'Dr. Anderson', studentGroup: 'CS-4', difficultyWeight: 0.95, satisfactionScore: 0.92, pinned: false, durationHours: 3 },
];
